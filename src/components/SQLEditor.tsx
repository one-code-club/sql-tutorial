  ...
  return (
    <div className="flex flex-col gap-2 h-full">
      <textarea
        ...
        onDrop={handleDrop}
        className="w-full h-full rounded-md border border-slate-700 bg-slate-900 p-3 font-mono text-sm text-slate-100 placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-brand-500/40"
        spellCheck={false}
      />
    </div>
  );
